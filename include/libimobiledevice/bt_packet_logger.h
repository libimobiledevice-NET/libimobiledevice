 ...
 */
LIBIMOBILEDEVICE_API_MSC bt_packet_logger_error_t bt_packet_logger_client_new(idevice_t device, lockdownd_service_descriptor_t service, bt_packet_logger_client_t * client);
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC bt_packet_logger_error_t bt_packet_logger_client_start_service(idevice_t device, bt_packet_logger_client_t * client, const char* label);
 ...
 *     client is NULL, or an BT_PACKET_LOGGER_E_* error code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC bt_packet_logger_error_t bt_packet_logger_client_free(bt_packet_logger_client_t client);
 ...
 */
LIBIMOBILEDEVICE_API_MSC bt_packet_logger_error_t bt_packet_logger_start_capture(bt_packet_logger_client_t client, bt_packet_logger_receive_cb_t callback, void* user_data);
 ...
 *      error occurs or an hci capture has already been started.
 */
LIBIMOBILEDEVICE_API_MSC bt_packet_logger_error_t bt_packet_logger_stop_capture(bt_packet_logger_client_t client);
 ...
 *      error occurs.
 */
LIBIMOBILEDEVICE_API_MSC bt_packet_logger_error_t bt_packet_logger_receive_with_timeout(bt_packet_logger_client_t client, char *data, uint32_t size, uint32_t *received, unsigned int timeout);
